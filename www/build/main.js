...
var DettaglioCorso = /** @class */ (function () {
    ...
    DettaglioCorso.prototype.formIsValid = function () {
    ...
    DettaglioCorso.prototype.submitForm = function () {
        if (this.formIsValid()) {
